...
def generate_protbert_features(root_dir):
    ...
    with open(root_dir + './po-inputs/id_list.txt', 'r') as f:
        protein_list = f.readlines()

        for protein in protein_list:

            seq = open(root_dir + './po-inputs/fasta/{}.fasta'.format(protein.strip()), 'r').readlines()
    ...
    print(len(all_protein_features))
    print(all_protein_features)

    pickle.dump({'ProtBert_features': all_protein_features},gzip.open(root_dir + '/ProtBert_features.pkl.gz','wb'))
